...
if ( ! class_exists('jobcareer_meta_fields') ) {
    ...
    class jobcareer_meta_fields {
        ...
        public function cs_form_layout_render($params = '') {
            ...
            $cs_output .= '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/no_sidebar.png"  alt="no_sidebar" />';
            $cs_output .= '</span>';
            ...
            $cs_output .= '<span class="ss">';
            $cs_output .= '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/sidebar_right.png" alt="sidebar_right" />';
            $cs_output .= '</span>';
            ...
            $cs_output .= '<span class="ss">';
            $cs_output .= '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/sidebar_left.png" alt="sidebar_left" />';
            $cs_output .= '</span>';
        ...
        public function cs_form_textarea_render($params = '') {
            ...
            $cs_opt_array = array(
                ...
                'echo' => true,
                'field_params' => array(
                    'std' => wp_specialchars_decode($value),
                    'cust_id' => 'cs_' . sanitize_html_class($id) . '',
                    'classes' => 'txtfield',
                    'cust_name' => 'cs_' . sanitize_html_class($id) . '',
                    'return' => true,
        ...
        public function cs_get_icon_for_attachment($post_id) {
            ...
            switch ( $type ) {
                ...
                case 'video/quicktime':
                    return '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/video.png' . '" alt="video"/>';
                    break;
                case 'text/csv':
                case 'text/plain':
                case 'text/xml':
                    return '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/attachment.png' . '" alt="attachment"/>';
                    break;
                default:
                    return '<img src="' . esc_url(get_template_directory_uri()) . '/backend/assets/images/attachment.png' . '" alt="attachment"/>';
                    break;
