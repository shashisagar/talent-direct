...
if (!function_exists('jobcareer_services_shortcode')) {
    ...
    function jobcareer_services_shortcode($atts, $content = null) {
        ...
        $html = "<p class='cs-deprecated'><i class='icon-warning2'></i> " . esc_html__("'Services' element has been deprecated but introducing new element 'Info Box' with extra features", 'jobcareer') . " </p>";
        return $html;
    }
