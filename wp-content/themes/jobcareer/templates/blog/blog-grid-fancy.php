...
if ( $query->have_posts() ) {
    ...
    while ( $query->have_posts() ) : $query->the_post();
        ...
        <div class="<?php echo esc_html($box_size); ?>">
            <div class="cs-blog blog-grid fancy">
                <div class="cs-media">
                    <figure>
                ...
                <div class="blog-text">
                    <strong class="author-name"><i class="icon-user2"></i> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php echo get_the_author_meta('display_name'); ?></a></strong>
                    ...
                    <div class="post-option">
                        <ul class="social-media">
                            <?php echo jobcareer_blog_single_share(0); ?>
                        </ul>
                        <span class="post-date"><i class="icon-calendar5"></i><a href="<?php echo get_month_link(get_the_time('Y'), get_the_time('m')); ?>"><?php echo get_the_date(); ?></a> </span>
                    </div>
