...
//            );
        ...
        $jobcareer_sett_options[] = array(
            ...
            array( 'default-footer' => esc_html__("Default Footer", 'jobcareer'),
                ...
                //'aviation-footer' => esc_html__("Aviation", 'jobcareer'),
            ),
        );
        $jobcareer_sett_options[] = array( "name" => esc_html__("Footer Background", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Choose footer Background from media gallery.", 'jobcareer'),
            "id" => "jobcareer_footer_background",
