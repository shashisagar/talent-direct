...
if (!function_exists('jobcareer_column_pb')) {
    ...
    function jobcareer_column_pb($die = 0, $shortcode = '') {
        ...
        if (isset($column_container)) {
            ...
            $section_images_view_page = $jobcareer_column_atts->section_images_view_page;
            ...
            $cs_section_particals = $jobcareer_column_atts->cs_section_particals;
                                        ...
                                        <div id="<?php echo esc_attr($name . $cs_counter); ?>_del" class="column  parentdelete  <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="<?php echo esc_attr($jobcareer_node->getName()); ?>" data="<?php echo jobcareer_element_size_data_array_index($jobcareer_node->page_element_size) ?>" >
                                            ...
                                            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" style="display: none;">
                                                ...
                                                <div class="pagebuilder-data-load demo dmeo">
                                                    ...
                                                    $cs_opt_array = array(
                                                        'std' => wp_specialchars_decode($jobcareer_node->cs_shortcode),
                                                        'cust_id' => '',
                        ...
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            ?>">
                                     ...
                                     $cs_opt_array = array(
                                         ...
                                         'field_params' => array(
                                             'std' => jobcareer_special_char($section_images_view_page),
                                             'id' => 'section_images_view_page',
                                             'cust_name' => 'section_images_view_page[]',
                                             'classes' => 'dropdown chosen-select',
                                             'extra_atr' => 'onchange="promotion_view(value)"',
                                             'options' => array(
                                                 'default' => esc_html__('Default', 'jobcareer'),
                                             //'aviation' => esc_html__('Aviation', 'jobcareer'),
                                             ),
                                             'return' => true,
                                         ),
                                     );
                                     $jobcareer_html_fields->cs_select_field($cs_opt_array);
//                                     $cs_opt_array = array(
//                                         'name' => esc_html__('Enable Particals', 'jobcareer'),
//                                         'desc' => '',
//                                         'hint_text' => '',
//                                         'echo' => true,
//                                         'field_params' => array(
//                                             'std' => $cs_section_particals,
//                                             'id' => '',
//                                             'cust_id' => '',
//                                             'cust_name' => 'cs_section_particals[]',
                                            ...
                                            <div class="meta-input pattern">
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_1<?php echo esc_attr($randomno) ?>">
                                                        <span class="ss"> <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'backend/assets/images/no_sidebar.png'; ?>"  alt="no_sidebar" />  </span>
                                                        <span  <?php
                                                        if ($cs_layout == "none") {
                                                ...
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_2<?php echo esc_attr($randomno) ?>">
                                                        <span class="ss"><img src="<?php echo trailingslashit(get_template_directory_uri()) . 'backend/assets/images/sidebar_right.png'; ?>" alt="sidebar_right" /></span>
                                                        <span <?php
                                                        if ($cs_layout == "right") {
                                                            echo "class='check-list'";
                                                        }
                                                ...
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_3<?php echo esc_attr($randomno); ?>">
                                                        <span class="ss">
                                                            <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'backend/assets/images/sidebar_left.png'; ?>" alt="sidebar_left" /></span> <span <?php
                                                        if ($cs_layout == "left") {
                                                            echo "class='check-list'";
                                                        }
                                                        ?> id="check-list">
