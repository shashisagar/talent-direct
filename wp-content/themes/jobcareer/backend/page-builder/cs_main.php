            ...
            if ( isset($_POST['builder_active']) ) {
                ...
                if ( isset($_POST['total_column']) ) {
                    foreach ( $_POST['total_column'] as $count_column ) {
                        ...
                        if ( empty($_POST['section_images_view_page'][$column_container_no]) ) {
                            $_POST['section_images_view_page'][$column_container_no] = "";
                        }
                        ...
                        if ( empty($_POST['cs_section_parallax'][$column_container_no]) ) {
						 ...
						 /* if ( empty($_POST['cs_section_particals'][$column_container_no]) ) {
                            $_POST['cs_section_particals'][$column_container_no] = "";
                        } */
                        ...
                        $column_container->addAttribute('section_images_view_page', $_POST['section_images_view_page'][$column_container_no]);
						...
						$column_container->addAttribute('cs_section_particals', $_POST['cs_section_particals'][$column_container_no]);
                            ...
                            for ( $j = 1; $j <= $a; $j ++ ) {
                                ...
                                // Save heading page element
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_element_images_view_page'][$cs_counter_heading]) && $_POST['cs_element_images_view_page'][$cs_counter_heading] != '' ) {
                                            $shortcode .= 'cs_element_images_view_page="' . htmlspecialchars($_POST['cs_element_images_view_page'][$cs_counter_heading], ENT_QUOTES) . '" ';
                                        }
                                        ...
                                        if ( isset($_POST['cs_image_url'][$cs_counter_heading]) && $_POST['cs_image_url'][$cs_counter_heading] != '' ) {
                                            $shortcode .= 'cs_image_url="' . htmlspecialchars($_POST['cs_image_url'][$cs_counter_heading], ENT_QUOTES) . '" ';
                                        }
...
//                                                }
                                ...
                                // video
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        } if ( isset($_POST['cs_video_view'][$counter_video]) && $_POST['cs_video_view'][$counter_video] != '' ) {
                                            $shortcode .= 'cs_video_view="' . htmlspecialchars($_POST['cs_video_view'][$counter_video], ENT_QUOTES) . '" ';
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['icon_box_num'][$cs_counter_icon_box]) && $_POST['icon_box_num'][$cs_counter_icon_box] > 0 ) {
                                            for ( $i = 1; $i <= $_POST['icon_box_num'][$cs_counter_icon_box]; $i ++ ) {
                                                ...
                                                if ( isset($_POST['cs_icon_box_hover_image_array'][$cs_counter_icon_box_node]) && $_POST['cs_icon_box_hover_image_array'][$cs_counter_icon_box_node] != '' ) {
                                                    $shortcode_item .= 'cs_icon_box_hover_image_array="' . htmlspecialchars($_POST['cs_icon_box_hover_image_array'][$cs_counter_icon_box_node], ENT_QUOTES) . '" ';
                                                }
