                    ...
                    <dt class="menu-item-handle">
                        ...
                        <span class="item-controls">
                            ...
                            <span class="item-order hide-if-js">
                                ...
                                ?>" class="item-move-up"><abbr title="<?php esc_html_e('Move up', 'jobcareer'); ?>">&#8593;</abbr></a>
                                |
                                <a href="<?php
                                echo wp_nonce_url(
                                        add_query_arg(
                                ...
                                ?>" class="item-move-down"><abbr title="<?php esc_html_e('Move down', 'jobcareer'); ?>">&#8595;</abbr></a>
                            </span>
                            <a class="item-edit" id="edit-<?php echo intval($item_id); ?>" title="<?php esc_html_e('Edit Menu Item', 'jobcareer'); ?>" href="<?php
