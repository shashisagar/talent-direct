...
if ( ! function_exists('jobcareer_pb_button') ) {
    ...
    function jobcareer_pb_button($die = 0) {
        ...
        $defaults = array(
            'column_size' => '', 'button_size' => 'btn-lg', 'button_border' => '', 'border_button_color' => '', 'button_title' => '', 'button_link' => '#', 'button_color' => '', 'button_bg_color' => '', 'button_icon_position' => '', 'button_icon' => '', 'button_type' => 'rounded', 'button_target' => '_self' );
                    ...
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        $cs_opt_array = array(
                            ...
                            'field_params' => array(
                                ...
                                'options' => array(
                                    '' => esc_html__('Select Position', 'jobcareer'),
