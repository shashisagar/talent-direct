                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Select newsletter style with this drop down two styles simple and classic.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => $cs_newsletter_style,
                                'id' => '',
                                'cust_id' => 'cs_newsletter_style',
                                'cust_name' => 'cs_newsletter_style[]',
