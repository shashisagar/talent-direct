                                ...
                                <ul id="gal-sortable">
                                    <li class="ui-state-default" id="">
                                        <div class="thumb-secs">
                                            <img src=""  id="cs_slider_image<?php echo intval($offer_count) ?>_img" width="100" height="150" alt="offer_count"  />
        ...
        <div class="to-social-network">
            <div class="gal-active cs-galactive">
                ...
                <div class="dragareamain">
                    <div class="placehoder"><?php esc_html_e('Gallery is Empty. Please Select Media', 'jobcareer'); ?> <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'backend/assets/images/bg-arrowdown.png'; ?>" alt="arrowdown" />
                    </div>
...
if ( ! function_exists('jobcareer_post_slick_list') ) {
    ...
    function jobcareer_post_slick_list($width, $height, $postid, $view) {
        ...
        foreach ( $sliderData as $as_node ) {
            $image_url = jobcareer_attachment_image_src((int) $as_node, $width, $height);
            echo ' <figure>
						<img src="' . esc_url($image_url) . '" alt="image_url"></figure>';
            if ( isset($as_node['title']) && $as_node['title'] != '' ) {
