...
if (!function_exists('jobcareer_counter_item_shortcode')) {
    ...
    function jobcareer_counter_item_shortcode($atts, $content = null) {
        ...
        $html = "<p class='cs-deprecated'><i class='icon-warning2'></i> " . esc_html__("'COUNTER' Page Builder element Replaced By multi counter in Current Theme Version. Please add it again.", 'jobcareer') . "</p>";
        return $html;
    }
