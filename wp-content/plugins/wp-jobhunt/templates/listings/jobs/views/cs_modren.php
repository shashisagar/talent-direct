                    ...
                    <div class="jobs-content<?php echo $featured_class; ?>">
                        ...
                        <div class="cs-text">
                            ...
                            <ul>
                                ...
                                <?php  do_action('show_custom_search_in_listing_jobs', $cs_job_id) ; ?>

                                <?php
                                $options_data = ob_get_clean();
                                $options_data = apply_filters('jobhunt_celine_entity_display', $options_data, $cs_job_id, $specialisms_values);
                                echo force_balance_tags($options_data);
