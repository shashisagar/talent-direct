 ...
 */
if ( ! class_exists('jobhunt_register_email_template') ) {

    class jobhunt_register_email_template {
        ...
        public function __construct() {
            ...
            add_action('jobhunt_user_register', array( $this, 'user_register_callback' ), 10, 2);
        }
        ...
        public function add_email_template() {
            ...
            $email_templates[$this->template_group][$this->email_template_index] = array(
                ...
                'description' => __('This template used to send email when user register.', 'jobhunt'),
                'jh_email_type' => 'html',
            );
            do_action('jobhunt_load_email_templates', $email_templates);
        }

        public function user_register_callback($user = '', $password = '') {
            ...
            if ( isset($template['email_notification']) && $template['email_notification'] == 1 ) {
                ...
                $subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : __('Registerd Successfully', 'jobhunt');
                ...
                do_action('jobhunt_send_mail', $email_args);
                jobhunt_register_email_template::$is_email_sent1 = $this->is_email_sent;
            }
        }

    }

    return new jobhunt_register_email_template();
}
